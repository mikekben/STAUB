...
namespace STAUB
{
  ...
  class SMTNode
  {
    public:
      ...
      inline func_decl Z3_bvnego(int width);
      inline func_decl Z3_bvsaddo(int width);
      inline func_decl Z3_bvssubo(int width);
      inline func_decl Z3_bvsmulo(int width);
      inline func_decl Z3_bvsdivo(int width);
